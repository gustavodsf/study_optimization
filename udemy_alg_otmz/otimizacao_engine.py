...
def genetico(dominio, funcao_custo, tamanho_populacao = 100, passo = 1, probabilidade_mutacao = 0.2, elitismo = 0.2, numero_geracoes = 200):
  populacao = []
